---
title: "How to add custom leagues"
---
...
can be listed with the [`available_leagues()`](../reference/fbref.md#soccerdata.FBref.available_leagues "soccerdata.FBref.available_leagues") class method.
